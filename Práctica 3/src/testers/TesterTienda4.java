...
public class TesterTienda4 {
	public static void main(String[] args) {
		...
		Venta anulada = Venta.anular(); // anulamos la �ltima venta, se asigna a
										// anulada
		System.out.println("Venta anulada:\n" + anulada.getTicket());

		Venta.anular(); // anulamos otra
		// eliminado por redundante Venta.resumenVentas(); // sin las dos
		// ultimas ventas
		System.out.println(Venta.resumenVentas(500)); // sin las dos ultimas
														// ventas, ni la de
														// importe < 500
		System.out.println(Venta.resumenVentas("Indes")); // solo ventas (no
															// anuladas) de
															// marca Indesit
